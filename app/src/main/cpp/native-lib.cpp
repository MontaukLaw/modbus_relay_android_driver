...
Java_com_example_modbus485controll_MainActivity_stringFromJNI(
        JNIEnv *env,
        jobject /* this */) {
...
Java_com_example_modbus485controll_SerialPort_open(JNIEnv *env, jobject thiz, jstring path, jint baudrate) {
    int fd;
    speed_t speed;
...
Java_com_example_modbus485controll_SerialPort_close(JNIEnv *env, jobject thiz) {
